...
public class ControllerDao implements Serializable {

	private static final long serialVersionUID = 1L;

	public ControllerDao(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(Inventario inventario) throws PropertyException, Exception {
        ...
        try {
            ...
            if (findInventario(inventario.getId()) != null) {
                throw new Exception("Inventario " + inventario + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(Inventario inventario) throws Exception, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findInventario(id) == null) {
                    throw new Exception("The inventario with id " + id + " no longer exists.");
                }
            }
            throw ex;
        } finally {
    ...
    public void destroy(Integer id) throws Exception {
        ...
        try {
            ...
            try {
                ...
                throw new Exception("The inventario with id " + id + " no longer exists.", enfe);
            }
